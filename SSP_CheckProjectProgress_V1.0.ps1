...
foreach ($projectFolder in $projectFolders) {
    $targetFolders = Get-ChildItem -Path $projectFolder -Recurse | Where-Object { $_.Name -Like "02_Kälte" -or $_.Name -Like "03_Kühlraum" -or $_.name -Like "05_Schema" -or $_.Name -Like "02 Kälte" -or $_.name -Like "03 Kühlraum" -or $_.Name -Like "05_Schema" }
